...
const STATUS_TO_TOAST: Record<string, { type: "success" | "error"; message: string }> = {
    "logged-in": { type: "success", message: "Logged in successfully." },
    "logged-out": { type: "success", message: "Logged out successfully." },
    registered: { type: "success", message: "Account created successfully. Please log in." },
    "login-error": { type: "error", message: "Invalid email or password." },
    "register-error": { type: "error", message: "Registration failed. Please try again." },
